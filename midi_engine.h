...
{
    const int SUSTAIN = 2000;
    const int PAUSE = 2001;
}
...
public:
    ...
    void exportTrack(QVector<Entity *> entities, int speed, int seed, int generation, int height, int width, int steps, int loops, int transposition);
